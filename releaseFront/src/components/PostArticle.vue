<template>
  <el-container v-loading="loading" class="post-article">
    <el-header class="header">
      ...
      <el-button v-else class="button-new-tag" type="info" size="small" @click="showInput">+Tag</el-button>
    </el-header>
    <el-main class="main">
      <div id="editor">
      ...
      <div style="display: flex;align-items: center;margin-top: 15px;justify-content: flex-end">
        ...
        <template v-if="from==undefined || from=='draft'">
          <el-button type="info" @click="saveBlog(0)">保存到草稿箱</el-button>
          <el-button type="success" @click="saveBlog(1)">发表文章</el-button>
        </template>
