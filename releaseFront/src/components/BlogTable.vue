...
<template>
  <div>
    <div style="display: flex;justify-content: flex-start">
      ...
      <!-- <el-button type="primary" icon="el-icon-search" size="mini" style="margin-left: 3px" round @click="searchClick">搜索
      </el-button> -->
      <el-button type="success" icon="el-icon-search" size="mini" circle @click="searchClick"></el-button>
    </div>
