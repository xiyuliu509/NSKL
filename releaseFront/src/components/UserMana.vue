<template>
  <div v-loading="loading">
    <div style="margin-top: 10px;display: flex;justify-content: center">
      ...
      <el-button type="success" round icon="el-icon-search" size="small" style="margin-left: 3px" @click="searchClick">搜索
      </el-button>
    </div>
    <div style="display: flex;justify-content: space-around;flex-wrap: wrap">
      <el-card style="width:330px;margin-top: 10px;font-weight:bolder" v-for="(user,index) in users" :key="index"
        ...
        <div>
          ...
          <div style="text-align: left;color:rgb(38,174,96);font-size: 12px;margin-top: 13px">
          ...
          <div
            style="text-align: left;color:rgb(38,174,96);font-size: 12px;margin-top: 13px;display: flex;align-items: center">
            <span>用户状态:</span>
            <el-switch
