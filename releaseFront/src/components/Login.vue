<template>
  <el-form :rules="rules" class="login-container" style="background-color:rgb(243,156,17)" label-position="left"
    ...
    <!-- <el-link class="signin" v-on:click="Sign_In" type="success">注册</el-link> -->
    <el-form-item style="width: 100%">
      <el-button type="success" @click.native.prevent="submitClick" style="width: 100%">登录</el-button>
    </el-form-item>
    <el-form-item style="width: 100%">
      <el-button type="warning" @click.native.prevent="Sign_In" style="width: 100%">注册</el-button>
    </el-form-item>
  </el-form>
</template>
<script>
